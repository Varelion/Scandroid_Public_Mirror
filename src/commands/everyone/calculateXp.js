...
const { Some_BioAndroid_COLOR, Some_BioAndroid_ICON_URL, DEV_SERVER_URL, COMBAT_MULTIPLIER } = require("../../config.json");
    ...
    async execute(guildService, interaction) {
        ...
        */
        ...
        let calculateEmbed = new EmbedBuilder()
            ...
            .setFields(
				{ inline: false, name: "NOTE", value: `Any value below will be multiplied by the 'COMBAT_MULTIPLIER' if the post is a combat post, meaning it starts with '!', and that value is ${COMBAT_MULTIPLIER}` },
			...
			.setThumbnail(Some_BioAndroid_ICON_URL)
