		...
		try {
			...
			const helpEmbed = new EmbedBuilder()
				...
				.setDescription(
					...
					"Sometimes you are happy roleplaying with your friends and don't want to gain more experience, wouldn't it be nice if you could just freeze your experience gain for a while? Well, you can; to do this, players must have the :ice_cube: (`🧊`) emoji within their nickname. If you do, you're frozen, and won't gain xp. "+
					"\n\n"+
					"# __Staff:__\n" +
