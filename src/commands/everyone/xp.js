...
const { Some_BioAndroid_RETIRE_COLOR, Some_BioAndroid_APPROVE_COLOR, Some_BioAndroid_LEVEL_UP_COLOR } = require("../../config.json");
...
module.exports = {
	...
	async execute(guildService, interaction) {
		...
		*/
		...
		let playerCharactersHelper = [...playerCharacters]; // Create a copy of the original array
		playerCharactersHelper.sort((a, b) => a["character_index"] - b["character_index"]); // sort the helper
		playerCharacters = playerCharactersHelper; //set helper to original

		let index = 0;
		for (let character of playerCharacters) {
			// console.log(`${character.name} is at index ${character["character_index"]}`);
				...
				case "xp_set":
					...
					*/
					...
					copyOfEmbed = new EmbedBuilder()
						...
						.setColor(Some_BioAndroid_APPROVE_COLOR);
				...
				case "xp_freeze":
					...
					*/
					...
					copyOfEmbed = new EmbedBuilder()
						...
						.setThumbnail(characterEmbedData.thumbnail.url)
						.setFooter(characterEmbedData.footer)
						.setColor(Some_BioAndroid_LEVEL_UP_COLOR);
				...
				case "xp_retire":
					if (!retire) {
						...
						*/
						...
						copyOfEmbed.setColor(Some_BioAndroid_RETIRE_COLOR);
