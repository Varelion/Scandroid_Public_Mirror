...
const { Some_BioAndroid_COLOR, Some_BioAndroid_ICON_URL, DEV_SERVER_URL, Some_BioAndroid_LEVEL_UP_COLOR, Some_BioAndroid_RETIRE_COLOR } = require("../../config.json");
...
module.exports = {
    ...
    async execute(guildService, interaction) {
        ...
        */
		...
		await interaction.editReply(`Success! ${player}'s character, \`${character.name}\`, at index \`${characterId}\` modified by \`${awardType}\` with value \`${value}\`.`);
    },
};
